...
#BLOCK TO FIX THE 00LOCK-massdataset bug on WINDOWS
# Get the default user library path
...
install.packages("ragg_1.4.0.zip", repos=NULL, type="source")
...
install.packages("pkgconfig_2.0.3.zip", repos=NULL, type="source")
install.packages("igraph_2.1.4.zip", repos=NULL, type="source")
...
#BLOCK TO FIX THE 00LOCK-massdataset bug on WINDOWS
# Construct the path to the 00LOCK-massdataset directory
lock_dir <- file.path(lib_path, "00LOCK-massdataset")
# Check if the directory exists and remove it if it does
if (dir.exists(lock_dir)) {
  message("Found '00LOCK-massdataset'. Removing it...")
  unlink(lock_dir, recursive = TRUE, force = TRUE)
  message("Directory removed successfully.")
} else {
  message("'00LOCK-massdataset' does not exist. Nothing to remove.")
}
...
install.packages("missForest_1.5.zip", repos=NULL, type="source")
